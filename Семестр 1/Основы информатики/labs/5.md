        ...
        (let ((command (vector-ref program index)))
          (cond
            ...
            ((equal? command 'mod) (solver (+ 1  index)
                                           (cons (remainder (cadr stack) (car stack)) (cddr stack)) stack_ret dictionary_))
            ((equal? command '=) (solver (+ 1  index)
            ...
            ((equal? command 'if) (solver (if (zero? (car stack)) (+ 1  (get_command_index 'endif program index)) (+ 1  index))
                                          (cdr stack) stack_ret dictionary_))
